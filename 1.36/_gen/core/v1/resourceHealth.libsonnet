{
  ...
  '#withMessage':: d.fn(help='"Message provides human-readable context for Health (e.g. \\"ECC error count exceeded threshold\\"). This field is populated by the kubelet when ResourceHealthStatusMessage is enabled if the DRA plugin returns a message, and is null otherwise."', args=[d.arg(name='message', type=d.T.string)]),
