{
  ...
  appArmorProfile: (import 'appArmorProfile.libsonnet'),
  ...
  clusterTrustBundleProjection: (import 'clusterTrustBundleProjection.libsonnet'),
  ...
  containerExtendedResourceRequest: (import 'containerExtendedResourceRequest.libsonnet'),
  containerImage: (import 'containerImage.libsonnet'),
  containerPort: (import 'containerPort.libsonnet'),
  containerResizePolicy: (import 'containerResizePolicy.libsonnet'),
  containerRestartRule: (import 'containerRestartRule.libsonnet'),
  containerRestartRuleOnExitCodes: (import 'containerRestartRuleOnExitCodes.libsonnet'),
  ...
  containerUser: (import 'containerUser.libsonnet'),
  ...
  fileKeySelector: (import 'fileKeySelector.libsonnet'),
  ...
  grpcAction: (import 'grpcAction.libsonnet'),
  hostAlias: (import 'hostAlias.libsonnet'),
  hostIP: (import 'hostIP.libsonnet'),
  ...
  imageVolumeSource: (import 'imageVolumeSource.libsonnet'),
  imageVolumeStatus: (import 'imageVolumeStatus.libsonnet'),
  ...
  lifecycleHandler: (import 'lifecycleHandler.libsonnet'),
  ...
  linuxContainerUser: (import 'linuxContainerUser.libsonnet'),
  ...
  modifyVolumeStatus: (import 'modifyVolumeStatus.libsonnet'),
  ...
  nodeAllocatableResourceClaimStatus: (import 'nodeAllocatableResourceClaimStatus.libsonnet'),
  ...
  nodeFeatures: (import 'nodeFeatures.libsonnet'),
  nodeRuntimeHandler: (import 'nodeRuntimeHandler.libsonnet'),
  nodeRuntimeHandlerFeatures: (import 'nodeRuntimeHandlerFeatures.libsonnet'),
  ...
  nodeSwapStatus: (import 'nodeSwapStatus.libsonnet'),
  ...
  podCertificateProjection: (import 'podCertificateProjection.libsonnet'),
  ...
  podExtendedResourceClaimStatus: (import 'podExtendedResourceClaimStatus.libsonnet'),
  podIP: (import 'podIP.libsonnet'),
  podOS: (import 'podOS.libsonnet'),
  podReadinessGate: (import 'podReadinessGate.libsonnet'),
  podResourceClaim: (import 'podResourceClaim.libsonnet'),
  podResourceClaimStatus: (import 'podResourceClaimStatus.libsonnet'),
  podSchedulingGate: (import 'podSchedulingGate.libsonnet'),
  podSchedulingGroup: (import 'podSchedulingGroup.libsonnet'),
  ...
  resourceHealth: (import 'resourceHealth.libsonnet'),
  ...
  resourceStatus: (import 'resourceStatus.libsonnet'),
  ...
  sleepAction: (import 'sleepAction.libsonnet'),
  ...
  typedObjectReference: (import 'typedObjectReference.libsonnet'),
  volume: (import 'volume.libsonnet'),
  volumeDevice: (import 'volumeDevice.libsonnet'),
  volumeMount: (import 'volumeMount.libsonnet'),
  volumeMountStatus: (import 'volumeMountStatus.libsonnet'),
  volumeNodeAffinity: (import 'volumeNodeAffinity.libsonnet'),
  volumeProjection: (import 'volumeProjection.libsonnet'),
  volumeResourceRequirements: (import 'volumeResourceRequirements.libsonnet'),
  volumeStatus: (import 'volumeStatus.libsonnet'),
