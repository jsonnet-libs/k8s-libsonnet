{
  ...
  '#withObservedGeneration':: d.fn(help='"If set, this represents the .metadata.generation that the pod condition was set based upon."', args=[d.arg(name='observedGeneration', type=d.T.integer)]),
