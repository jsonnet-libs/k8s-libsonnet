{
  ...
  '#withPodGroupTemplates':: d.fn(help='"PodGroupTemplates is the list of templates that make up the Workload. The maximum number of templates is 8. This field is immutable."', args=[d.arg(name='podGroupTemplates', type=d.T.array)]),
  withPodGroupTemplates(podGroupTemplates): { podGroupTemplates: if std.isArray(v=podGroupTemplates) then podGroupTemplates else [podGroupTemplates] },
  '#withPodGroupTemplatesMixin':: d.fn(help='"PodGroupTemplates is the list of templates that make up the Workload. The maximum number of templates is 8. This field is immutable."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podGroupTemplates', type=d.T.array)]),
  withPodGroupTemplatesMixin(podGroupTemplates): { podGroupTemplates+: if std.isArray(v=podGroupTemplates) then podGroupTemplates else [podGroupTemplates] },
  '#mixin': 'ignore',
  mixin: self,
}
