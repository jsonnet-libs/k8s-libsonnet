{
  ...
  '#withVerbs':: d.fn(help='"verbs is a list of kubernetes non-resource API verbs, like: get, post, put, delete, patch, head, options.  \\"*\\" means all."', args=[d.arg(name='verbs', type=d.T.array)]),
  withVerbs(verbs): { verbs: if std.isArray(v=verbs) then verbs else [verbs] },
  '#withVerbsMixin':: d.fn(help='"verbs is a list of kubernetes non-resource API verbs, like: get, post, put, delete, patch, head, options.  \\"*\\" means all."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='verbs', type=d.T.array)]),
