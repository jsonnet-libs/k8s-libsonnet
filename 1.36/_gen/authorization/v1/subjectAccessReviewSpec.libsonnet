{
  ...
  '#':: d.pkg(name='subjectAccessReviewSpec', url='', help='"SubjectAccessReviewSpec is a description of the access request.  Exactly one of resourceAttributes and nonResourceAttributes must be set"'),
