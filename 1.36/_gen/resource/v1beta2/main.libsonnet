{
  ...
  capacityRequestPolicy: (import 'capacityRequestPolicy.libsonnet'),
  capacityRequestPolicyRange: (import 'capacityRequestPolicyRange.libsonnet'),
  capacityRequirements: (import 'capacityRequirements.libsonnet'),
  ...
  deviceCapacity: (import 'deviceCapacity.libsonnet'),
  ...
  exactDeviceRequest: (import 'exactDeviceRequest.libsonnet'),
  networkDeviceData: (import 'networkDeviceData.libsonnet'),
  nodeAllocatableResourceMapping: (import 'nodeAllocatableResourceMapping.libsonnet'),
