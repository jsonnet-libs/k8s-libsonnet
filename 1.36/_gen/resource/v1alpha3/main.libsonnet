{
  ...
  poolStatus: (import 'poolStatus.libsonnet'),
  resourcePoolStatusRequest: (import 'resourcePoolStatusRequest.libsonnet'),
  resourcePoolStatusRequestSpec: (import 'resourcePoolStatusRequestSpec.libsonnet'),
  resourcePoolStatusRequestStatus: (import 'resourcePoolStatusRequestStatus.libsonnet'),
}
