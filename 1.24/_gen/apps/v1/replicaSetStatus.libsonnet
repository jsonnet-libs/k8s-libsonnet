{
  ...
  '#withReadyReplicas':: d.fn(help='"readyReplicas is the number of pods targeted by this ReplicaSet with a Ready Condition."', args=[d.arg(name='readyReplicas', type=d.T.integer)]),
