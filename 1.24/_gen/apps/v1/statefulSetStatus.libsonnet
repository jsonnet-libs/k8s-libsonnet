{
  ...
  '#withAvailableReplicas':: d.fn(help='"Total number of available pods (ready for at least minReadySeconds) targeted by this statefulset. This is a beta field and enabled/disabled by StatefulSetMinReadySeconds feature gate."', args=[d.arg(name='availableReplicas', type=d.T.integer)]),
