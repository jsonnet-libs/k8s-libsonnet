{
  ...
  metadata: {
    ...
    '#withClusterName':: d.fn(help='"Deprecated: ClusterName is a legacy field that was always cleared by the system and never used; it will be removed completely in 1.25.\\n\\nThe name in the go struct is changed to help clients detect accidental use."', args=[d.arg(name='clusterName', type=d.T.string)]),
