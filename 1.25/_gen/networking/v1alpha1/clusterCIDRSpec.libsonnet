{
  ...
  '#withIpv6':: d.fn(help='"IPv6 defines an IPv6 IP block in CIDR notation(e.g. \\"fd12:3456:789a:1::/64\\"). At least one of IPv4 and IPv6 must be specified. This field is immutable."', args=[d.arg(name='ipv6', type=d.T.string)]),
