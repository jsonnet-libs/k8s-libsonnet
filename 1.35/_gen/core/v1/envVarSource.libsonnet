{
  ...
  '#fileKeyRef':: d.obj(help='"FileKeySelector selects a key of the env file."'),
  fileKeyRef: {
    ...
    withKey(key): { fileKeyRef+: { key: key } },
    ...
    withOptional(optional): { fileKeyRef+: { optional: optional } },
