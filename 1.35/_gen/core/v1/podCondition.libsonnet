{
  ...
  '#withObservedGeneration':: d.fn(help='"If set, this represents the .metadata.generation that the pod condition was set based upon. The PodObservedGenerationTracking feature gate must be enabled to use this field."', args=[d.arg(name='observedGeneration', type=d.T.integer)]),
