{
  ...
  '#withReady':: d.fn(help='"The number of pods which have a Ready condition.\\n\\nThis field is alpha-level. The job controller populates the field when the feature gate JobReadyPods is enabled (disabled by default)."', args=[d.arg(name='ready', type=d.T.integer)]),
