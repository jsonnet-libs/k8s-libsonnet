{
  ...
  '#withType':: d.fn(help="\"Type of daemon set update. Can be \\\"RollingUpdate\\\" or \\\"OnDelete\\\". Default is RollingUpdate.\\n\\nPossible enum values:\\n - `\\\"OnDelete\\\"` Replace the old daemons only when it's killed\\n - `\\\"RollingUpdate\\\"` Replace the old daemons by new ones using rolling update i.e replace them on each node one after the other.\"", args=[d.arg(name='type', type=d.T.string)]),
