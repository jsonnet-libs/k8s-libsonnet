{
  ...
  '#withType':: d.fn(help='"Type of deployment. Can be \\"Recreate\\" or \\"RollingUpdate\\". Default is RollingUpdate.\\n\\nPossible enum values:\\n - `\\"Recreate\\"` Kill all existing pods before creating new ones.\\n - `\\"RollingUpdate\\"` Replace the old ReplicaSets by new one using rolling update i.e gradually scale down the old ReplicaSets and scale up the new one."', args=[d.arg(name='type', type=d.T.string)]),
