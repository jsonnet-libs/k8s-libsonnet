---
permalink: /1.36/resource/v1beta1/nodeAllocatableResourceMapping/
---

# resource.v1beta1.nodeAllocatableResourceMapping
...
* [`fn withAllocationMultiplier(allocationMultiplier)`](#fn-withallocationmultiplier)
* [`fn withCapacityKey(capacityKey)`](#fn-withcapacitykey)

## Fields

### fn withAllocationMultiplier

```ts
withAllocationMultiplier(allocationMultiplier)
```
