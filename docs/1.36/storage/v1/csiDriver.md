---
permalink: /1.36/storage/v1/csiDriver/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withNodeAllocatableUpdatePeriodSeconds(nodeAllocatableUpdatePeriodSeconds)`](#fn-specwithnodeallocatableupdateperiodseconds)
  * [`fn withPodInfoOnMount(podInfoOnMount)`](#fn-specwithpodinfoonmount)
  * [`fn withPreventPodSchedulingIfMissing(preventPodSchedulingIfMissing)`](#fn-specwithpreventpodschedulingifmissing)
  ...
  * [`fn withServiceAccountTokenInSecrets(serviceAccountTokenInSecrets)`](#fn-specwithserviceaccounttokeninsecrets)
...
### fn spec.withNodeAllocatableUpdatePeriodSeconds
...
### fn spec.withPreventPodSchedulingIfMissing

```ts
withPreventPodSchedulingIfMissing(preventPodSchedulingIfMissing)
```
...
### fn spec.withServiceAccountTokenInSecrets

```ts
withServiceAccountTokenInSecrets(serviceAccountTokenInSecrets)
```
