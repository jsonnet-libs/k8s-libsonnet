---
permalink: /1.36/scheduling/v1alpha2/podGroup/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withDisruptionMode(disruptionMode)`](#fn-specwithdisruptionmode)
  ...
  * [`obj spec.podGroupTemplateRef`](#obj-specpodgrouptemplateref)
    * [`obj spec.podGroupTemplateRef.workload`](#obj-specpodgrouptemplaterefworkload)
      * [`fn withPodGroupTemplateName(podGroupTemplateName)`](#fn-specpodgrouptemplaterefworkloadwithpodgrouptemplatename)
      * [`fn withWorkloadName(workloadName)`](#fn-specpodgrouptemplaterefworkloadwithworkloadname)
  * [`obj spec.schedulingConstraints`](#obj-specschedulingconstraints)
    * [`fn withTopology(topology)`](#fn-specschedulingconstraintswithtopology)
    * [`fn withTopologyMixin(topology)`](#fn-specschedulingconstraintswithtopologymixin)
  * [`obj spec.schedulingPolicy`](#obj-specschedulingpolicy)
    * [`fn withBasic(basic)`](#fn-specschedulingpolicywithbasic)
    * [`fn withBasicMixin(basic)`](#fn-specschedulingpolicywithbasicmixin)
    * [`obj spec.schedulingPolicy.gang`](#obj-specschedulingpolicygang)
      * [`fn withMinCount(minCount)`](#fn-specschedulingpolicygangwithmincount)
