---
permalink: /1.36/core/v1/podStatus/
---
...
* [`fn withNodeAllocatableResourceClaimStatuses(nodeAllocatableResourceClaimStatuses)`](#fn-withnodeallocatableresourceclaimstatuses)
* [`fn withNodeAllocatableResourceClaimStatusesMixin(nodeAllocatableResourceClaimStatuses)`](#fn-withnodeallocatableresourceclaimstatusesmixin)
...
* [`obj extendedResourceClaimStatus`](#obj-extendedresourceclaimstatus)
  * [`fn withRequestMappings(requestMappings)`](#fn-extendedresourceclaimstatuswithrequestmappings)
  * [`fn withRequestMappingsMixin(requestMappings)`](#fn-extendedresourceclaimstatuswithrequestmappingsmixin)
  * [`fn withResourceClaimName(resourceClaimName)`](#fn-extendedresourceclaimstatuswithresourceclaimname)
...
### fn withNodeAllocatableResourceClaimStatuses

```ts
withNodeAllocatableResourceClaimStatuses(nodeAllocatableResourceClaimStatuses)
```
...
### fn withNodeAllocatableResourceClaimStatusesMixin

```ts
withNodeAllocatableResourceClaimStatusesMixin(nodeAllocatableResourceClaimStatuses)
```
...
### fn extendedResourceClaimStatus.withRequestMappings
...
### fn extendedResourceClaimStatus.withRequestMappingsMixin
...
### fn extendedResourceClaimStatus.withResourceClaimName
