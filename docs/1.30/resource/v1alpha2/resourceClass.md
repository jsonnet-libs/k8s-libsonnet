---
permalink: /1.30/resource/v1alpha2/resourceClass/
---
...
* [`fn withStructuredParameters(structuredParameters)`](#fn-withstructuredparameters)
...
* [`obj parametersRef`](#obj-parametersref)
  ...
  * [`fn withNamespace(namespace)`](#fn-parametersrefwithnamespace)
...
new returns an instance of ResourceClass
...
### fn withStructuredParameters

```ts
withStructuredParameters(structuredParameters)
```
...
### fn parametersRef.withNamespace
