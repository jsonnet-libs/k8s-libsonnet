---
permalink: /1.35/core/v1/nodeStatus/
---
...
* [`fn withDeclaredFeatures(declaredFeatures)`](#fn-withdeclaredfeatures)
* [`fn withDeclaredFeaturesMixin(declaredFeatures)`](#fn-withdeclaredfeaturesmixin)
...
### fn withDeclaredFeatures

```ts
withDeclaredFeatures(declaredFeatures)
```

"DeclaredFeatures represents the features related to feature gates that are declared by the node."

### fn withDeclaredFeaturesMixin

```ts
withDeclaredFeaturesMixin(declaredFeatures)
```
