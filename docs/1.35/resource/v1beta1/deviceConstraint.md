---
permalink: /1.35/resource/v1beta1/deviceConstraint/
---
...
* [`fn withDistinctAttribute(distinctAttribute)`](#fn-withdistinctattribute)
...
### fn withDistinctAttribute

```ts
withDistinctAttribute(distinctAttribute)
```
