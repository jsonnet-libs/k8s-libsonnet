---
permalink: /1.35/batch/v1/cronJob/
---
    ...
    * [`obj spec.jobTemplate.spec`](#obj-specjobtemplatespec)
      ...
      * [`obj spec.jobTemplate.spec.template`](#obj-specjobtemplatespectemplate)
        ...
        * [`obj spec.jobTemplate.spec.template.spec`](#obj-specjobtemplatespectemplatespec)
          ...
          * [`fn withHostnameOverride(hostnameOverride)`](#fn-specjobtemplatespectemplatespecwithhostnameoverride)
          ...
          * [`obj spec.jobTemplate.spec.template.spec.resources`](#obj-specjobtemplatespectemplatespecresources)
            * [`fn withClaims(claims)`](#fn-specjobtemplatespectemplatespecresourceswithclaims)
            * [`fn withClaimsMixin(claims)`](#fn-specjobtemplatespectemplatespecresourceswithclaimsmixin)
            * [`fn withLimits(limits)`](#fn-specjobtemplatespectemplatespecresourceswithlimits)
            * [`fn withLimitsMixin(limits)`](#fn-specjobtemplatespectemplatespecresourceswithlimitsmixin)
            * [`fn withRequests(requests)`](#fn-specjobtemplatespectemplatespecresourceswithrequests)
            * [`fn withRequestsMixin(requests)`](#fn-specjobtemplatespectemplatespecresourceswithrequestsmixin)
          * [`obj spec.jobTemplate.spec.template.spec.securityContext`](#obj-specjobtemplatespectemplatespecsecuritycontext)
            ...
            * [`fn withSeLinuxChangePolicy(seLinuxChangePolicy)`](#fn-specjobtemplatespectemplatespecsecuritycontextwithselinuxchangepolicy)
            ...
            * [`fn withSupplementalGroupsPolicy(supplementalGroupsPolicy)`](#fn-specjobtemplatespectemplatespecsecuritycontextwithsupplementalgroupspolicy)
          ...
          * [`obj spec.jobTemplate.spec.template.spec.workloadRef`](#obj-specjobtemplatespectemplatespecworkloadref)
            * [`fn withName(name)`](#fn-specjobtemplatespectemplatespecworkloadrefwithname)
            * [`fn withPodGroup(podGroup)`](#fn-specjobtemplatespectemplatespecworkloadrefwithpodgroup)
            * [`fn withPodGroupReplicaKey(podGroupReplicaKey)`](#fn-specjobtemplatespectemplatespecworkloadrefwithpodgroupreplicakey)
...
### fn spec.jobTemplate.spec.template.spec.withHostnameOverride
...
## obj spec.jobTemplate.spec.template.spec.resources

"ResourceRequirements describes the compute resource requirements."

### fn spec.jobTemplate.spec.template.spec.resources.withClaims
...
### fn spec.jobTemplate.spec.template.spec.resources.withClaimsMixin
...
### fn spec.jobTemplate.spec.template.spec.resources.withLimits
...
### fn spec.jobTemplate.spec.template.spec.resources.withLimitsMixin
...
### fn spec.jobTemplate.spec.template.spec.resources.withRequests
...
### fn spec.jobTemplate.spec.template.spec.resources.withRequestsMixin
...
### fn spec.jobTemplate.spec.template.spec.securityContext.withSeLinuxChangePolicy
...
### fn spec.jobTemplate.spec.template.spec.securityContext.withSupplementalGroupsPolicy
...
## obj spec.jobTemplate.spec.template.spec.workloadRef
...
### fn spec.jobTemplate.spec.template.spec.workloadRef.withName
...
### fn spec.jobTemplate.spec.template.spec.workloadRef.withPodGroup
...
### fn spec.jobTemplate.spec.template.spec.workloadRef.withPodGroupReplicaKey
