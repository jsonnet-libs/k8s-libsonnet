{
  ...
  '#withAvailableReplicas':: d.fn(help='"Total number of available pods (ready for at least minReadySeconds) targeted by this statefulset. This is an alpha field and requires enabling StatefulSetMinReadySeconds feature gate. Remove omitempty when graduating to beta"', args=[d.arg(name='availableReplicas', type=d.T.integer)]),
